...
user1 = Editor(name="Thadius Pitts", email="thadiusp@gmail.com",
...
movie1 = Movies(editor_id=1, title="The Bourne Identity", year="2002",
...
movie2 = Movies(editor_id=1, title="Elysium", year="2013",
...
genre3 = Genre(editor_id=1, type="Comedy")

session.add(genre3)
session.commit()

movie1 = Movies(editor_id=1, title='Dumb and Dumber', year="1994",
...
movie2 = Movies(editor_id=1, title='Blockers', year='2018',
...
genre4 = Genre(editor_id=1, type="Drama")

session.add(genre4)
session.commit()

movie1 = Movies(editor_id=1, title="The Departed", year="2006",
...
movie2 = Movies(editor_id=1, title="The Wolf of Wall Street", year="2013",
...
genre5 = Genre(editor_id=1, type="Romance")

session.add(genre5)
session.commit()

movie1 = Movies(editor_id=1, title="You've Got Mail", year="1998",
...
movie2 = Movies(editor_id=1, title="The Notebook", year="2004",
...
genre6 = Genre(editor_id=1, type="SciFi")

session.add(genre6)
session.commit()

movie1 = Movies(editor_id=1, title="Star Wars", year="1977",
...
movie2 = Movies(editor_id=1, title="Star Trek", year="2009",
